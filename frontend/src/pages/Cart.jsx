...
const Cart = () => {
  ...
  const handleDelete = async (bookId) => {
    ...
    try {
      ...
      setCart(cart.filter((item) => item._id !== bookId)); // Update the cart state after deletion
    } catch (error) {
    ...
    <div className="bg-zinc-900 px-12 py-8 h-screen">
      {cart && cart.length === 0 ? (
        <div className="h-screen">
          <div className="h-[100%] bg-zinc-900 flex flex-col items-center justify-center text-5xl">
